...
export interface FilterConfig {
  ...
  districts?: string[];
  /**
   * Garder les annonces sans quartier connu quand des quartiers sont cochés.
   * Absent = oui : les digests des portails n'en indiquent jamais.
   */
  includeUnknownDistrict?: boolean;
}
