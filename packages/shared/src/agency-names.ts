 ...
 *
 * IL VIVAIT DANS LE COLLECTEUR, et le site ne pouvait pas l'importer : l'écran
 * des agences s'était donc écrit sa propre règle, plus faible, qui comptait
 * « CITYA DALBERA » et « CITYA DALBERRA » comme deux maisons. Deux réponses à
 * la même question, dont la plus fausse était celle qu'on voyait. Il est ici
 * pour qu'il n'y en ait plus qu'une.
 */
